defmodule Housefit.Accounts do
  @moduledoc """
  ...
  alias Housefit.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Housefit.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Housefit.Accounts.User.password_changeset/3` for a list of supported options.
